...
body .btn-default {
  ...
  .open > body .btn-default.dropdown-toggle {
    ...
    border-color: #3d3d3d;
    background: transparent; }
    body .btn-default:active:hover, body .btn-default:active:focus, body .btn-default:active.focus, body .btn-default.active:hover, body .btn-default.active:focus, body .btn-default.active.focus,
  ...
  body .btn-default.disabled:hover, body .btn-default.disabled:focus, body .btn-default.disabled.focus, body .btn-default[disabled]:hover, body .btn-default[disabled]:focus, body .btn-default[disabled].focus,
...
.label-cerulean {
  background-color: #00A3E3; }
  .label-cerulean[href]:hover, .label-cerulean[href]:focus {
    background-color: #007eb0; }

.label-curious-blue {
  background-color: #2986c7; }
  .label-curious-blue[href]:hover, .label-curious-blue[href]:focus {
    background-color: #206a9d; }

.label-endaveour {
  background-color: #0055a3; }
  .label-endaveour[href]:hover, .label-endaveour[href]:focus {
    background-color: #003a70; }

.label-minsk {
  background-color: #362d88; }
  .label-minsk[href]:hover, .label-minsk[href]:focus {
    background-color: #272062; }

.label-eminence {
  background-color: #742787; }
  .label-eminence[href]:hover, .label-eminence[href]:focus {
    background-color: #521c5f; }

.label-violet-eggplant {
  background-color: #aa1985; }
  .label-violet-eggplant[href]:hover, .label-violet-eggplant[href]:focus {
    background-color: #7e1262; }

.label-mint-green {
  background-color: #72ff96; }
  .label-mint-green[href]:hover, .label-mint-green[href]:focus {
    background-color: #3fff70; }

.label-aquamarine {
  background-color: #62ffe0; }
  .label-aquamarine[href]:hover, .label-aquamarine[href]:focus {
    background-color: #2fffd6; }

.label-malibu {
  background-color: #6abfff; }
  .label-malibu[href]:hover, .label-malibu[href]:focus {
    background-color: #37a9ff; }

.label-dodger-blue {
  background-color: #5e6cff; }
  .label-dodger-blue[href]:hover, .label-dodger-blue[href]:focus {
    background-color: #2b3dff; }

.label-heliotrope {
  background-color: #a26bff; }
  .label-heliotrope[href]:hover, .label-heliotrope[href]:focus {
    background-color: #8238ff; }

.label-perfume {
  background-color: #f57ffe; }
  .label-perfume[href]:hover, .label-perfume[href]:focus {
    background-color: #f14cfe; }

.label-brand-cerulean {
  background-color: #00A3E3; }
  .label-brand-cerulean[href]:hover, .label-brand-cerulean[href]:focus {
    background-color: #007eb0; }
