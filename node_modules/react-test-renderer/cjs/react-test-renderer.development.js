...
var ReactVersion = '17.0.3-2c9fef32d';
  ...
  while (nextEffect !== null) {
    ...
    if (deletions !== null) {
      for (var i = 0; i < deletions.length; i++) {
        ...
        {
          invokeGuardedCallback(null, commitDeletion, null, root, childToDelete, fiber);
...
function commitMutationEffects_complete(root) {
  while (nextEffect !== null) {
    ...
    {
      setCurrentFiber(fiber);
      invokeGuardedCallback(null, commitMutationEffectsOnFiber, null, fiber, root);
...
function performSyncWorkOnRoot(root) {
  ...
  if (root === workInProgressRoot && areLanesExpired(root, workInProgressRootRenderLanes)) {
...
function flushPassiveEffects() {
  ...
  if (pendingPassiveEffectsLanes !== NoLanes) {
    var priority = higherEventPriority(DefaultEventPriority, lanesToEventPriority(pendingPassiveEffectsLanes));
    var prevTransition = ReactCurrentBatchConfig$2.transition;
    var previousPriority = getCurrentUpdatePriority();
...
function create(element, options) {
  ...
  var root = createContainer(container, isConcurrent ? ConcurrentRoot : LegacyRoot, false, null, strictModeLevel);
